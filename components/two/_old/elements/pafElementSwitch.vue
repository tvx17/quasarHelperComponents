<template>
  <div class="text-overline">
    <div class="row">
      <div :class="[firstColumnWidth, elementValue === undefined || elementValue === '' ? 'text-red' : '']">
        {{ props.label }}
      </div>
      <div class="col">
        <div class="row">
          <div class="col">
            <q-btn-group flat rounded :style="elementValue === undefined || elementValue === '' ? 'background-color:red;' : ''">
              <q-btn
        ...
        <div class="row" v-if="elementValue === undefined || elementValue === ''">
